...
public class FilmService implements FilmImpl {
    ...
    public FilmService(){
        ...
        Film F1 = new Film(1, "Avatar", dateSortie1, 182, "Malgré sa paralysie, Jake Sully, un ancien marine immobilisé dans un fauteuil roulant, est resté un combattant au plus profond de son être. Il est recruté pour se rendre à des années-lumière de la Terre, sur Pandora, où de puissants groupes industriels exploitent un minerai rarissime destiné à résoudre la crise énergétique sur Terre. Parce que l'atmosphère de Pandora est toxique pour les humains, ceux-ci ont créé le Programme Avatar, qui permet à des \" pilotes \" humains de lier leur esprit à un avatar, un corps biologique commandé à distance, capable de survivre dans cette atmosphère létale. Ces avatars sont des hybrides créés génétiquement en croisant l'ADN humain avec celui des Na'vi, les autochtones de Pandora.\n" +
                "Sous sa forme d'avatar, Jake peut de nouveau marcher. On lui confie une mission d'infiltration auprès des Na'vi, devenus un obstacle trop conséquent à l'exploitation du précieux minerai. Mais tout va changer lorsque Neytiri, une très belle Na'vi, sauve la vie de Jake... ", "https://i1.wp.com/www.filmspourenfants.net/wp-content/uploads/2018/01/avatar-a.jpg?fit=777%2C1033&ssl=1", "<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/O1CzgULNRGs\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>", G1, castList1, CR1 ,null );
        filmList.add(F1);
    ...
    public Film getById(int id) {
        ...
        Film F1 = new Film(1, "Forrest Gump", dateSortie1, 160, "Quelques décennies d'histoire américaine, des années 1940 à la fin du XXème siècle, à travers le regard et l'étrange odyssée d'un homme simple et pur, Forrest Gump. ", "https://fr.web.img4.acsta.net/pictures/15/10/13/15/12/514297.jpg", "<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/GRe3ZsXAZE4\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>" ,G3, castList1, CR1 ,null );
        filmList.add(F1);
